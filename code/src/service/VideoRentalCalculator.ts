...
export interface VideoRentalCalculator {
  statement(invoices: Invoice[], plays: Plays): string;
}

export class VideoRentalCalculatorImpl implements VideoRentalCalculator {
  statement(invoices: Invoice[], plays: Plays): string {
    let totalAmount = 0;
    let volumeCredits = 0;
